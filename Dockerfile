...
RUN curl -L https://huggingface.co/Systran/faster-whisper-large-v3/resolve/main/model.bin?download=true --create-dirs -o /root/.cache/huggingface/hub/models--Systran--faster-whisper-large-v3/blobs/bf2a9746382e1aa7ffff6b3a0d137ed9edbd9670c3b87e5d35f5e85e70d0333a
